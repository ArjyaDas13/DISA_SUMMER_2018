...
def SBP(ref,trans):
    ...
    print "Strict Brevity Penalty = ",pow(e,power)
    return pow(e,power)
...
def SRP(ref,trans):
    ...
    print "Strict Redundancy Penalty = ",pow(e,power)
    return pow(e,power)
...
def CSRP(ref,trans):
    ...
    print "Strict Character Based Redundancy Penalty = ", pow(e,power)
    return pow(e,power)
...
def SWDP(ref,trans):
    ...
    e=2.71828
    print "Short Word Difference Penalty = ", pow(e,-power)
    return pow(e,-power)
...
def LWDP(ref,trans):
    ...
    e=2.71828
    print "Long Word Difference Penalty = ", pow(e,-power)
    return pow(e,-power)
...
def CTP(ref,trans):
    ...
    power=(-(a+b+c)/3.0)
    d=pow(e,power)
    print "Continuity penalty power = ",power
    return d
